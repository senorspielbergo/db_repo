...
,
bstimmenprokandidat AS -- Gültige Stimmen für Direktkandidaten pro Wahljahr
(
   SELECT
      bs.wahljahr,
      bs.direktkandidat,
...
,
bstimmengueltigkeit AS -- Gültige Erststimmen
(
   SELECT
      bs.wahljahr,
...
,
bwahlkreisstimmenprolandesliste AS -- Absolute und prozentuale Zahl an Stimmen für Landeslisten pro Wahljahr
(
...
,
helptable AS -- Verknüpfung von erststimme und zweitstimme pro Wahljahr
(
   SELECT
      e.wahljahr,
      e.partei,
